...
CREATE TABLE "BatchRun" (
    ...
    "shadowRuleVersionId" TEXT,
    "shadowRuleVersionDisplay" TEXT,
    "shadowRulesetChecksum" TEXT,
    "shadowEvaluationMode" TEXT,
    "deliveryKey" TEXT,
...
-- Phase 3A connector instances. Catalogue definitions remain code-owned;
-- these rows are organisation-scoped configuration/readiness metadata only.
...
-- Phase 3B append-only connectivity evidence. No credential material or
-- response body is stored; safeDetailsJson is an allow-listed diagnostic set.
