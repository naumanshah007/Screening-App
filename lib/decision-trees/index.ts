...
const FIGURE_1: FigureDef = {
  ...
  nodes: [
    ...
    { id: 'neg',    type: 'outcome',  label: '5-Year Routine Recall',   sublabel: 'F1-NEG-5Y',               risk: 'LOW',    x: 85,  y: 320, codes: ['F1-NEG-5Y'] },
    { id: 'inad',   type: 'outcome',  label: 'Repeat HPV — 3 Months',  sublabel: 'F1-INAD-3M',              risk: 'MEDIUM', x: 325, y: 320, codes: ['F1-INAD-3M'] },
    { id: 'cyt',    type: 'decision', label: 'Cytology?',               x: 550, y: 320, width: 160, height: 80 },
    { id: 'p2',     type: 'outcome',  label: 'Colposcopy — P2',         sublabel: 'F1-16-18-COLP',           risk: 'HIGH',   x: 775, y: 320, codes: ['F1-16-18-COLP'] },
    { id: 'neg12',  type: 'outcome',  label: 'Repeat Co-test — 12 Months', sublabel: 'F1-HPVO-NEG-12M',     risk: 'MEDIUM', x: 415, y: 460, codes: ['F1-HPVO-NEG-12M'] },
    { id: 'colp2',  type: 'outcome',  label: 'Colposcopy — P2',         sublabel: 'F1-HPVO-ABN-COLP',       risk: 'HIGH',   x: 655, y: 460, codes: ['F1-HPVO-ABN-COLP'] },
  ],
  edges: [
...
const FIGURE_2: FigureDef = {
  ...
  nodes: [
    ...
    { id: 'neg5y', type: 'outcome',  label: '5-Year Routine Recall',       sublabel: 'F2-NEG-5Y',   risk: 'LOW',    x: 60,  y: 320, codes: ['F2-NEG-5Y', 'F2-CONSEC-NEG-5Y'] },
    { id: 'inad',  type: 'outcome',  label: 'Repeat HPV — 6 Weeks',       sublabel: 'F2-INAD-6W',  risk: 'MEDIUM', x: 300, y: 320, codes: ['F2-INAD-6W', 'F2-2ND-INAD-COLP'] },
    { id: 'cyt',   type: 'decision', label: 'Cytology?',                   x: 525, y: 320, width: 160, height: 80 },
    { id: 'p2hi',  type: 'outcome',  label: 'Colposcopy — P2',            sublabel: 'F2-1618-COLP', risk: 'HIGH',   x: 750, y: 320, codes: ['F2-1618-COLP'] },
    { id: '12m',   type: 'outcome',  label: 'Repeat Co-test — 12 Months', sublabel: 'F2-HPVO-12M', risk: 'MEDIUM', x: 405, y: 460, codes: ['F2-HPVO-12M', 'F2-HPVO-2ND-COLP'] },
    { id: 'colp3', type: 'outcome',  label: 'Colposcopy — P3',            sublabel: 'F2-ABN-COLP', risk: 'HIGH',   x: 645, y: 460, codes: ['F2-ABN-COLP'] },
  ],
  edges: [
    { id: 'e1', from: 'start', to: 'hpv' },
...
const FIGURE_3: FigureDef = {
  ...
  nodes: [
    ...
    { id: 'neg5y',   type: 'outcome',  label: '5-Year Routine Recall',        sublabel: 'F3-NEG-5Y',    risk: 'LOW',    x: 60,  y: 320, codes: ['F3-NEG-5Y', 'F3-IC-3Y'] },
    { id: 'inad',    type: 'outcome',  label: 'Repeat HPV — 6 Weeks',        sublabel: 'F3-INAD-6W',   risk: 'MEDIUM', x: 300, y: 320, codes: ['F3-INAD-6W', 'F3-2ND-INAD-COLP'] },
    { id: 'cytO',    type: 'decision', label: 'Cytology? (HPV Other)',        x: 535, y: 320, width: 180, height: 80 },
    { id: 'cyt1618', type: 'decision', label: 'Cytology? (HPV 16/18)',        x: 765, y: 320, width: 180, height: 80 },
    { id: 'lowO',    type: 'outcome',  label: 'Repeat Co-test — 12 Months',  sublabel: 'F3-HPVO-LOW-12M',  risk: 'MEDIUM', x: 265, y: 470, codes: ['F3-HPVO-LOW-12M', 'F3-HPVO-NEG-12M'] },
    { id: 'highO',   type: 'outcome',  label: 'Colposcopy — P2',             sublabel: 'F3-HPVO-HIGH-COLP', risk: 'HIGH',  x: 505, y: 470, codes: ['F3-HPVO-HIGH-COLP', 'F3-HIGH-COLP'] },
    { id: 'low16',   type: 'outcome',  label: 'Colposcopy — P2',             sublabel: 'F3-1618-LOW-COLP',  risk: 'HIGH',  x: 745, y: 470, codes: ['F3-1618-LOW-COLP', 'F3-1618-NEG-COLP'] },
    { id: 'high16',  type: 'outcome',  label: 'Colposcopy — P1/P2',          sublabel: 'F3-1618-HIGH-COLP', risk: 'URGENT',x: 985, y: 470, codes: ['F3-1618-HIGH-COLP', 'F3-HIGH-URGENTCOLP'] },
  ],
  edges: [
    { id: 'e1', from: 'start',   to: 'hpv' },
    { id: 'e2', from: 'hpv',     to: 'neg5y',   label: 'Not Detected' },
...
const FIGURE_4: FigureDef = {
  ...
  nodes: [
    ...
    { id: 'norm',  type: 'outcome',  label: 'Repeat Co-test — 12 Months',  sublabel: 'F4-NORM-12M',    risk: 'LOW',    x: 70,  y: 320, codes: ['F4-NORM-12M', 'F4-NORM-COLP-12M'] },
    { id: 'lsil',  type: 'process',  label: 'Biopsy? (Low-grade)',          x: 310, y: 320 },
    { id: 'hsil',  type: 'outcome',  label: 'Treatment / Excision',        sublabel: 'F4-HSIL-TREAT',  risk: 'HIGH',   x: 550, y: 320, codes: ['F4-HSIL-TREAT', 'F4-HSIL-COLP'] },
    { id: 'inv',   type: 'outcome',  label: 'MDM + Urgent Oncology',       sublabel: 'F4-INV-MDM',     risk: 'URGENT', x: 790, y: 320, codes: ['F4-INV-MDM', 'F4-INV-URGENT'] },
    { id: 'cin1',  type: 'outcome',  label: 'Repeat Co-test — 12 Months',  sublabel: 'F4-CIN1-12M',    risk: 'LOW',    x: 190, y: 470, codes: ['F4-CIN1-12M'] },
    { id: 'cin23', type: 'outcome',  label: 'Treatment Recommended',       sublabel: 'F4-CIN23-TREAT', risk: 'HIGH',   x: 430, y: 470, codes: ['F4-CIN23-TREAT', 'F4-CIN2-TREAT', 'F4-CIN3-TREAT'] },
  ],
  edges: [
...
const FIGURE_5: FigureDef = {
  ...
  nodes: [
    ...
    { id: 'colp',  type: 'decision', label: 'Colposcopic Impression?',      x: 430, y: 160, width: 220, height: 90 },
    { id: 'hsil',  type: 'outcome',  label: 'Excision / Treatment',        sublabel: 'F5-HSIL-EXC',  risk: 'HIGH',   x: 95,  y: 320, codes: ['F5-HSIL-EXC', 'F5-CIN3-TREAT'] },
    { id: 'ais',   type: 'outcome',  label: 'Cone Biopsy + MDM',           sublabel: 'F5-AIS-CONE',  risk: 'HIGH',   x: 335, y: 320, codes: ['F5-AIS-CONE', 'F5-AIS-MDM'] },
    { id: 'inv',   type: 'outcome',  label: 'MDM — Urgent Oncology',       sublabel: 'F5-INV-MDM',   risk: 'URGENT', x: 575, y: 320, codes: ['F5-INV-MDM', 'F5-INV-URGENT'] },
    { id: 'mdm',   type: 'outcome',  label: 'MDM Review Required',         sublabel: 'F5-MDM',       risk: 'HIGH',   x: 815, y: 320, codes: ['F5-MDM', 'F5-DISCORDANT-MDM'] },
  ],
  edges: [
    { id: 'e1', from: 'start', to: 'colp' },
...
const FIGURE_6: FigureDef = {
  ...
  nodes: [
    ...
    { id: 'hpv',     type: 'decision', label: 'HPV Result?',                  x: 430, y: 160, width: 200, height: 90 },
    { id: 'neg1st',  type: 'outcome',  label: 'Repeat Co-test — 12 Months',  sublabel: 'F6-TOC-6M-NEG',       risk: 'LOW',    x: 45,  y: 320, codes: ['F6-TOC-6M-NEG'] },
    { id: 'dis',     type: 'outcome',  label: 'Discharge to 5-Year Recall',  sublabel: 'F6-TOC-DISCHARGE-5Y', risk: 'LOW',    x: 285, y: 320, codes: ['F6-TOC-DISCHARGE-5Y', 'F6-TOC-DISCHARGE-IC-3Y'] },
    { id: 'hpvoN',   type: 'outcome',  label: 'Repeat Co-test — 12 Months',  sublabel: 'F6-HPVO-12M',         risk: 'MEDIUM', x: 525, y: 320, codes: ['F6-HPVO-12M'] },
    { id: 'persist', type: 'outcome',  label: 'Colposcopy — P2',             sublabel: 'F6-PERSIST-COLP',     risk: 'HIGH',   x: 765, y: 320, codes: ['F6-PERSIST-COLP'] },
    { id: 'relapse', type: 'outcome',  label: 'Urgent Colposcopy — P1',      sublabel: 'F6-RELAPSE-URGCOLP',  risk: 'URGENT', x: 1010, y: 220, codes: ['F6-RELAPSE-URGCOLP', 'F6-ABN-12M'] },
  ],
  edges: [
    { id: 'e1', from: 'start', to: 'hpv' },
...
const FIGURE_7: FigureDef = {
  ...
  nodes: [
    ...
    { id: 'ag1',   type: 'outcome',  label: 'Colposcopy — P3',             sublabel: 'F7-AG1-COLP',  risk: 'MEDIUM', x: 70,  y: 320, codes: ['F7-AG1-COLP', 'F7-AG1-AC1-COLP'] },
    { id: 'ag2',   type: 'outcome',  label: 'Gynaecology Referral',        sublabel: 'F7-AG2-GYN',   risk: 'HIGH',   x: 310, y: 320, codes: ['F7-AG2-GYN', 'F7-AG2-ATEND-GYN'] },
    { id: 'ag35',  type: 'outcome',  label: 'Colposcopy — P2',            sublabel: 'F7-AG3-COLP',  risk: 'HIGH',   x: 550, y: 320, codes: ['F7-AG3-COLP', 'F7-HIGH-COLP'] },
    { id: 'ac24',  type: 'outcome',  label: 'Gynaecology Referral — P2',  sublabel: 'F7-AC2-GYN',   risk: 'HIGH',   x: 790, y: 320, codes: ['F7-AC2-GYN', 'F7-AC-HIGH-GYN'] },
  ],
  edges: [
...
const FIGURE_8: FigureDef = {
  ...
  nodes: [
    ...
    { id: 'neg',   type: 'outcome',  label: 'No Further Recall Required',  sublabel: 'F8-VAULT-NEG',  risk: 'LOW',    x: 35,  y: 320, codes: ['F8-VAULT-NEG'] },
    { id: 'sat',   type: 'outcome',  label: 'Repeat Vault Cytology',       sublabel: 'F8-VAULT-SAT',  risk: 'LOW',    x: 275, y: 320, codes: ['F8-VAULT-SAT', 'F8-VAULT-UNSAT'] },
    { id: 'abn',   type: 'outcome',  label: 'Colposcopy Referral — P3',   sublabel: 'F8-VAULT-ABN',  risk: 'MEDIUM', x: 515, y: 320, codes: ['F8-VAULT-ABN', 'F8-VAULT-LG'] },
    { id: 'high',  type: 'outcome',  label: 'Colposcopy — P2 / Urgent',   sublabel: 'F8-VAULT-HG',   risk: 'HIGH',   x: 755, y: 320, codes: ['F8-VAULT-HG', 'F8-VAULT-URGENT'] },
  ],
  edges: [
...
const FIGURE_10: FigureDef = {
  ...
  nodes: [
    ...
    { id: 'cancer', type: 'outcome',  label: 'Urgent Referral — Suspected Cancer', sublabel: 'F10-CANCER-SYMPTOMS-URGENT-GYN', risk: 'URGENT', x: 45,  y: 320, codes: ['F10-CANCER-SYMPTOMS-URGENT-GYN', 'F10-CANCER-URGENT'] },
    { id: 'sti',    type: 'outcome',  label: 'Treat STI — Recall 3 Months',      sublabel: 'F10-STI-TREAT',  risk: 'MEDIUM', x: 285, y: 320, codes: ['F10-STI-TREAT'] },
    { id: 'oc',     type: 'outcome',  label: 'Adjust OC / Recall 3 Months',      sublabel: 'F10-OC-ADJUST',  risk: 'LOW',    x: 525, y: 320, codes: ['F10-OC-ADJUST'] },
    { id: 'res',    type: 'decision', label: 'Bleeding Resolved?',                x: 750, y: 320, width: 160, height: 80 },
    { id: 'screen', type: 'outcome',  label: 'Routine Cervical Screen',          sublabel: 'F10-ROUTINE-SCREEN', risk: 'LOW',  x: 570, y: 460, codes: ['F10-ROUTINE-SCREEN'] },
    { id: 'refer',  type: 'outcome',  label: 'Gynaecology Referral',             sublabel: 'F10-GYN-REFER',  risk: 'HIGH',   x: 810, y: 460, codes: ['F10-GYN-REFER'] },
  ],
  edges: [
